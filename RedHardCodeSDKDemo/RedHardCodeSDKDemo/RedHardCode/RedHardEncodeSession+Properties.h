...
@interface RedHardCode (EncoderProperties)
...
/**
 * @see kVTCompressionPropertyKey_ExpectedFrameRate
 */
- (NSTimeInterval)ExpectedFrameRate;

/**
 * @see kVTCompressionPropertyKey_ExpectedFrameRate(实验没有作用，只能通过采集端来控制帧率)
 */
